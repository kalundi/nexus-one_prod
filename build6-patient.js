(function(){
 ...
 $('#profileForm').addEventListener('submit',e=>{e.preventDefault();N.write(N.KEYS.profile,Object.fromEntries(new FormData(e.target)));render();$('#portalNotice').textContent='Profile updated.'});
