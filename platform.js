...
(function(){
	...
	function ensureStyle(){
		...
		style.id=STYLE_ID;
		style.textContent=`
.footer.footerUnified{position:relative;margin-top:24px;background:linear-gradient(180deg,#082f49 0%,#07283f 100%);color:#d4e5f1;border-top:1px solid rgba(255,255,255,.12);}
...
.footer.footerUnified .footerSocial a[aria-label="YouTube"] svg,.footer.footerUnified .footerSocial a[aria-label="TikTok"] svg,.footer.footerUnified .footerSocial a[aria-label="Instagram"] svg,.footer.footerUnified .footerSocial a[aria-label="Facebook"] svg,.footer.footerUnified .footerSocial a[aria-label="Bluesky"] svg{fill:currentColor;stroke:none;}
@media (max-width:980px){.footer.footerUnified .footerGrid{grid-template-columns:1fr 1fr;gap:12px 16px;padding:12px 0 8px !important;}.footer.footerUnified .footerBrandCompact{border-right:0;padding-right:0;margin-right:0;}.footer.footerUnified .footerBrandCompact .footerLogo{width:clamp(150px,34vw,190px);}.footer.footerUnified .footerBrandCompact p{font-size:14px !important;}}
@media (max-width:620px){.footer.footerUnified .shell{width:calc(100% - 24px) !important;}.footer.footerUnified .footerGrid{grid-template-columns:1fr;gap:10px;padding-top:12px !important;}}
		`;
