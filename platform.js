...
(function(){
 ...
 let tries=0;function sync(){lockHomeMenuStyles();normalizeNav();addSectionReturns();ensureCarouselRotation();if(tries++<50)setTimeout(sync,120)}if(document.readyState==='loading')document.addEventListener('DOMContentLoaded',sync,{once:true});else sync();
})();
